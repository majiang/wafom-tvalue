...
template exponential(double a, size_t s)
{
    double f(double[] xs)
    in
    {
...
template cosineProd(double a, size_t s)
{
    double f(double[] xs)
    in
    {
...
template cosineOfSum(double a, size_t s)
{
    double f(double[] xs)
    in
    {
...
template gaussian(double a, size_t s)
{
    double f(double[] xs)
    in
    {
...
template characteristic(double a, size_t s)
{
    double f(double[] xs)
    in
    {
...
// a = 1/3 and binary rational
template sharppp(double a, size_t s)
{
    double f(double[] xs)
    {
...
template productPeak(double a, size_t s)
{
    double f(double[] xs)
    {
